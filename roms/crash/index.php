...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">Crash (Exidy, 1979)</h1>
	...
	<center>
		<div class="btn btn-success">
			<h4><a href="crash.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Crash ROM images</a></h4>
