...
<div class="container">
	...
	<center><h1 class="page-header">Side Trak (Exidy, 1979)</h1></center>
						...
						<a href="sidetrac.zip" onclick="return isChecked();" title="Download now"  class="btn-success"><h4>Download the Side Trak ROM images</h4></a>
					...
					<h2>Description</h2>
					<p>
					<b>Side Trak</b> is a black &amp; white man-versus-machine game where the goal is to pick up all of
					...
					that, passengers picked up when you have additional cars in tow add another 10 points to car.
					</p>
