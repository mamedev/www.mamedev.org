...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">FAX (Exidy, 1983)</h1>
	...
	<center>
		<div class="btn btn-success">
			<h4><a href="fax.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the FAX ROM images</a></h4>
			<h4><a href="fax2.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the FAX 2 ROM images</a></h4>
