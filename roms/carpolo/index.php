...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">Car Polo (Exidy, 1977)</h1>
	...
	<center>
		<div class="btn btn-success">
			<h4><a href="carpolo.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Car Polo ROM images</a></h4>
