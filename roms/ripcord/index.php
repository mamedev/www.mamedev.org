...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">Rip Cord (Exidy, 1979)</h1>
	...
	<center>
		<div class="btn btn-success">
			<h4><a href="ripcord.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Rip Cord ROM images</a></h4>
	...
	<p>
	<b>Rip Cord</b> was another black and white game released by Exidy in 1979. It was designed
