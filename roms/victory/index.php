...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">Victory (Exidy, 1982)</h1>
	...
	<center>
		<div class="btn btn-success">
			<h4><a href="victory.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Victory ROM images</a></h4>
			<h4><a href="victorba.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Victor Banana ROM images</a></h4>
