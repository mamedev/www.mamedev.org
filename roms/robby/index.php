...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">Robby Roto (Bally/Midway, 1981)</h1>
	...
	<center>
		<div class="btn btn-success">
			<h4><a href="robby.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Robby Roto ROM images</a></h4>
