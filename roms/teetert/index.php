...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">Teeter Torture (Exidy, 1982)</h1>
	...
	<center>
		<div class="btn btn-success">
			<h4><a href="teetert.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Teeter Torture ROM images</a></h4>
	...
	<a href="http://www.caextreme.org" target="_blank">California Extreme</a> show for a number of years.)
	For years there was even confusion as to whether it was an Exidy-produced prototype or some bootleg
	running on Exidy hardware.
	</p>
