...
<div class="container">
	...
	<h1 class="page-header" style="text-align: center">Hard Hat (Exidy, 1982)</h1>
	...
	<center>
		...
		<h4><a href="hardhat.zip" onclick="return isChecked();" title="Download now" class="btn-success">Download the Hard Hat ROM images</a></h4>
